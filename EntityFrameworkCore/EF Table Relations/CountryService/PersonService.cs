...
namespace Service
{
	public class PersonService : IPersonService
	{
		...
		public PersonResponse GetPersonByID(Guid? personID)
		{
			...
			Person? person= _db.Persons.Include(p=>p.Country).Where(p => p.PersonID == personID).FirstOrDefault();
			if (person==null)
			{
		...
		public List<PersonResponse> GetAllPersons()
		{
			...
			List<PersonResponse> personresponses = _db.Persons.Include(p=>p.Country).ToList()
