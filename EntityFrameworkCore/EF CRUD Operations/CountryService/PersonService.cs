...
namespace Service
{
	public class PersonService : IPersonService
	{
		...
		public PersonResponse GetPersonByID(Guid? personID)
		{
			...
			Person? person= _db.Persons.Where(p => p.PersonID == personID).FirstOrDefault();
			if (person==null)
			{
		...
		public List<PersonResponse> GetAllPersons()
		{
			 ...
			 */
			List<PersonResponse> personresponses = _db.Persons.ToList()
		...
		public PersonResponse UpdatePerson(PersonUpdateRequest? personUpdateRequest)
		{
			...
			Person? FoundedPerson=_db.Persons.FirstOrDefault(p => p.PersonID == personUpdateRequest.PersonID);
			...
			_db.SaveChanges();
			PersonResponse Response = ConvertPersonToPersonResponse(FoundedPerson);
